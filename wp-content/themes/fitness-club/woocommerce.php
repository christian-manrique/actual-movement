...
echo '<section class="boldSection gutter btWooCommerce ' . esc_attr( BoldThemesFramework::$left_alignment_class ) . ' ' . $extra_class . '">';
	echo '<div class="port">';
...
if ( is_product() && ( comments_open() || get_comments_number() ) ) {
	echo '<section class="boldSection btComments gutter topSmallSpaced bottomSpaced">';
		echo '<div class="port">';
			echo '<div class="boldCell">';
				echo '<div class="boldRow">';
					echo '<div class="rowItem col-md-12 col-ms-12 animate-fadein animate ' . esc_attr( BoldThemesFramework::$left_alignment_class ) . ' ' . '">';
						comments_template();
					echo '</div>';
				echo '</div>';
			echo '</div>';
