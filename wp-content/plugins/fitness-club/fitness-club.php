	...
	if ( function_exists( 'bt_rc_map' ) ) {
		...
		bt_rc_map( 'bt_image', array( 'name' => __( 'Image', 'bt_plugin' ), 'description' => __( 'Single image', 'bt_plugin' ), 'container' => 'vertical', 'accept' => array( 'bt_header' => true, 'bt_text' => true, 'bt_hr' => true, 'bt_icons' => true, 'bt_button' => true ), 
			'params' => array(
				...
				array( 'param_name' => 'size', 'type' => 'dropdown', 'heading' => __( 'Size', 'bt_plugin' ),
					'value' => array(
		...
		bt_rc_map( 'bt_section', array( 'name' => __( 'Section', 'bt_plugin' ), 'description' => __( 'Basic root element', 'bt_plugin' ), 'root' => true, 'container' => 'vertical', 'accept' => array( 'bt_row' => true ), 'toggle' => true, 'show_settings_on_create' => false,
			'params' => array( 
				...
				array( 'param_name' => 'back_overlay', 'type' => 'dropdown', 'heading' => __( 'Background Overlay', 'bt_plugin' ), 
					'value' => array(
						__( 'None', 'bt_plugin' )				=> '',
...
if ( ! class_exists( 'BT_Weather_Widget' ) ) {
	...
	class BT_Weather_Widget extends WP_Widget {
		...
		public function widget( $args, $instance ) {
			...
			echo '<span id="' . $this->container_id . '" class="btIconWidget"><span class="btIconWidgetIcon">' . boldthemes_get_icon_html( 'wi_f03e', '', '', 'btIcoDefaultType btIcoAccentColor3', '' ) . '</span><span class="btIconWidgetContent"><span class="btIconWidgetTitle"></span><span class="btIconWidgetText"></span></span></span>';
		}
